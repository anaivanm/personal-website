...
projects = [
	...
	{ name: 'Copenhagen Wine', description: 'Ruby on Rails, PostgreSQL', git_url: 'https://github.com/anaivanm/flare', web_url: 'www.sendaflare.com', photo: 'color-project-flare.pngg' },
